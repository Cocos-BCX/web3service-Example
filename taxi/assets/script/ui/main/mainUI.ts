...
export class mainUI extends Component {
    @property(Label)
    lbAddress: Label = null!;
    @property(Label)
    lbBalanceOf: Label = null!;
    ...
    start() {
        ...
        this.lbAddress.string = playerData.instance.web3ProviderData.signerAddress
    }
    ...
    updateGold() {
        ...
        this.lbBalanceOf.string = `${ethersHelper.instance.datas.gold}`
    }
